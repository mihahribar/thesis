...
Cilj diplomske naloge je razvoj knjižnice za RRULE RFC5545\footnote{\href{http://tools.ietf.org/html/rfc5545\#section-3.3.10}{http://tools.ietf.org/html/rfc5545\#section-3.3.10}} specifikacije, ki omogoča generiranje ponavljajočih se koledarskih dogodkov in jo je možno uporabiti v spletni, iOS, Android in Windows Phone aplikaciji. Našteli bomo možne pristope, navedli prednosti in slabosti, ter na koncu izbrali najbolj primerno rešitev za implementacijo knjižnice.
\end{Povzetek}
