...
\newglossaryentry{ios}{name=iOS, description={Mobilni opracijski sistem razvit pri podjetju Apple. Najdemo ga na napravah iPhone, iPad, iPod in Apple TV}}
\newglossaryentry{android}{name=Android, description={Operacijski sistem, razvit pri podjetju Google, namenjen uporabi na mobilnih napravah}}
\newglossaryentry{wp}{name=Windows Phone, description={Mobilni operacijski sistem razvit pri podjetju Microsoft}}
