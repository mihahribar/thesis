...
% - PhDp for a PhD thesis proposal - predlog teme doktorske disertacije
...
\documentclass[english,PhDp,oneside]{FRIthesis}

% titlepage info
% - use \title[short title][short other language title]{title}{other language title} to define the title; short titles are optional; 
...
\title[LaTeX thesis class]%
      [LaTeX predloga]%
      {University of Ljubljana, Faculty of Computer and Information Science \LaTeX\ thesis class}%
      {\LaTeX\ predloga Fakultete za računalništvo in informatiko Univerze v Ljubljani}
\author{Sum Buddy}{12345678}
\advisor{Waj Zgaj}
        {Waja Zgaja}
\coadvisor{Brej Niak (Massachussets Instutute of Technology)}
          {Breja Niaka (Massachussets Instutute of Technology)}
...
\input{thesis_proposal_body}
\input{thesis_proposal_bibliography}
\input{thesis_appendix_biography}
\input{thesis_appendix_bibliography}
