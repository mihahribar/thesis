...
%-----
\section{Predstavitev knjižnice RFC 5545}
...
Iz tabel \ref{table:omejitve-celovite-hibridne} in \ref{table:omejitve-deljene} je lepo razvidno, da edino rešitev C++ zadošča vsem naštetim omejitvam. Poglejmo si torej kako lahko izbrano rešitev pripravimo s pomočjo jezika C++, ter kako lahko nato isto rešitev uporabimo tudi v aplikaciji, ki teče spletnem brskalniku, s pomočjo ogrodja Emscripten.

\begin{table}
\begin{tabular}{ l | c | c | c | c | c }
  \hline
  Omejitev/Rešitev & Qt & Xamarin & Air & Cordova & Titanium \\
  \hline
  Android 					& \cmark & \cmark & \cmark & \cmark & \cmark \\
  iOS 						& \cmark & \cmark & \cmark & \cmark & \cmark \\
  Windows Phone 			& \xmark & \cmark & \xmark & \cmark & \xmark \\
  Spletna aplikacija 		& \xmark & \xmark & \cmark & \cmark & \xmark \\
  Grafična skladnost 		& \xmark & \cmark & \xmark & \xmark & \cmark \\
  Skupnost 					& \cmark & \cmark & \xmark & \cmark & \cmark \\
  Odpornost na nadgradnje 	& \xmark & \xmark & \xmark & \xmark & \xmark \\
  Cena (mesečno) 			& 149\$  & 299\$  & -      & -      & - \\
  \hline
\end{tabular}
\label{table:omejitve-celovite-hibridne}
\caption{Pregled funkcionalnosti celovitih in hibridnih metod.}
\end{table}

\begin{table}
\begin{tabular}{ l | c | c | c | c }
  \hline
  Omejitev/Rešitev & Lua & Haxe & C++ & JavaScript \\
  \hline
  Android 					& \cmark & \cmark & \cmark & \cmark \\
  iOS 						& \cmark & \cmark & \cmark & \cmark \\
  Windows Phone 			& \cmark & \cmark & \cmark & \cmark \\
  Spletna aplikacija 		& \cmark & \cmark & \cmark & \cmark \\
  Grafična skladnost 		&        &        &        &        \\
  Skupnost 					& \cmark & \xmark & \cmark & \cmark \\
  Odpornost na nadgradnje	& \xmark & \xmark & \cmark & \xmark \\
  Cena (mesečno) 			& -      & -      & -      & -      \\
  \hline
\end{tabular}
\label{table:omejitve-deljene}
\caption{Pregled funkcionalnosti deljenih metod.}
\end{table}
